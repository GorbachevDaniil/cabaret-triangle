...
std::vector<double> findLinesIntersection(double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4){
...
Cell::Cell(Mesh &mesh, long id, long node_id_1, long node_id_2, long node_id_3){
    ...
    intersectionCoords = findLinesIntersection(x1, y1, (x2+x3)/2, (y2+y3)/2, x3, y3, (x1+x2)/2, (y1+y2)/2);
