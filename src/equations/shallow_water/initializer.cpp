...
//        mesh.v0[i][0].y = 0;
        ...
        mesh.s0[i][0] = 1 + exp(-100 * (pow(x, 2) + pow(y, 2))) / 1000;
        mesh.v0[i][0].x = 0;
        mesh.v0[i][0].y = 0;
...
//        for (unsigned long i : edge->used_node_ids) {
////            Node *node = &mesh.nodes[i];
////            double x = node->coords.x;
////            double y = node->coords.y;
//
...
//                avgU.x = avgU.x + mesh.v0[nodeID][0].x;
//                avgU.y = avgU.y + mesh.v0[nodeID][0].y;
//                num++;
//            }
//        }
//
//        mesh.s0[cell->center_node_id][0] = avgH / num;
//        mesh.v0[cell->center_node_id][0].x = avgU.x / num;
//        mesh.v0[cell->center_node_id][0].y = avgU.y / num;
//    }
}
